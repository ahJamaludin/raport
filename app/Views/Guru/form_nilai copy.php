                                        ...
                                        <?php if ($detailmapelkelas['id_mapelkelas'] == $key['id_mapelkelas']) { ?>
                                            <tr>
                                                ...
                                                <!-- <td class="text-center">
                                                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $key['id_siswa'] ?>"><i class="fas fa-book-open"></i></button>

                                                    <a href="" class="btn btn-success btn-sm"><i class="fas fa-book-open"></i></a>
                                                </td> -->
