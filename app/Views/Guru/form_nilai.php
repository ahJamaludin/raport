                                        ...
                                        <?php if ($detailmapelkelas['id_mapelkelas'] == $key['id_mapelkelas']) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <!-- <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $key['id_mapelkelas'] ?>"><i class="fas fa-book-open"></i></button> -->
                                                    <a href="<?= base_url('guru/nilai_mapel/nilaikelas/' . $key['id_mapelkelas']); ?>" class="btn btn-success btn-sm"><i class="fas fa-book-open"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php endforeach; ?>
