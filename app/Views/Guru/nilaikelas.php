                    ...
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool btn-primary" data-toggle="modal" data-target="#add"><i class="fas fa-plus"></i> Add</button>
                                <a href="<?= base_url('guru/nilai/edit_rombelmapel/'); ?>" class="btn btn-success btn-sm"><i class="fas fa-book-open"></i></a>
                            </div>
                            <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                                        ...
                                        <?php if ($detailmapelkelas['id_mapelkelas'] == $key['id_mapelkelas']) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $key['id_rombelmapel'] ?>"><i class="fas fa-book-open"></i></button>
                                                </td>
