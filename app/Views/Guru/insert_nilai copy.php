                                        ...
                                        <?php if ($detailmapelkelas['id_mapelkelas'] == $key['id_mapelkelas']) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#add<?= $key['id_rombelmapel']; ?>"><i class="fas fa-book-open"></i></button>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php endforeach; ?>
    ...
    <?php foreach ($rombelkelas as $key => $value) { ?>
        <div class="modal fade" id="add<?= $value['id_rombelmapel'] ?>">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?= form_open('guru/nilai_mapel/edit_rombelmapel/' . $value['id_rombelmapel'].'/'.$value['id_mapelkelas']); ?>
                        <?= csrf_field(); ?>
    ...
    <!-- /.modal edit-->
    <?php foreach ($rombelkelas as $key => $value) { ?>
        <div class="modal fade" id="edit<?= $value['id_rombelmapel'] ?>">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header card-outline card-success">
