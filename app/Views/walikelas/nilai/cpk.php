                                                ...
                                                <div class="p-0">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            <!-- <tr>
                                                                <th style="width: 200px">Religius</th>

                                                                <td><?= $key['religius'] ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th style="width: 200px">Nasionalis</th>
                                                                <td><?= $key['nasionalis'] ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th style="width: 200px">Mandiri</th>
                                                                <td><?= $key['mandiri'] ?></td>
                                                            </tr>
                                                            <tr>
                                                                <th style="width: 200px">Gotong_royong</th>
                                                                <td><?= $key['gotong_royong'] ?></td> -->
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
