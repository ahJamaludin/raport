        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open('walikelas/c_karakter/add/' . $value['id_anggota_rombel']); ?>
                    <?= csrf_field(); ?>
    ...
    <div class="modal fade" id="edit<?= $value['id_anggota_rombel'] ?>">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open('walikelas/c_karakter/edit/' . $value['id_anggota_rombel']); ?>
                    <?= csrf_field(); ?>
                    ...
                    <div class="mb-3 row">
                        <label for="catatan_karakter" class="col-sm-3 col-form-label">Catatan Karakter</label>
                        <div>
                            <label class="col-sm-1 col-form-label">:</label>
                        </div>
                        <div class="col-sm-8">
                            <input name="catatan_karakter" id="catatan_karakter" class="form-control" value="<?= $value['catatan_karakter']; ?>">
                        </div>
                    </div>
