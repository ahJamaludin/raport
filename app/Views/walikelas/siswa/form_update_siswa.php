        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?= base_url('walikelas/siswa/view/' . $siswa['id_siswa']) ?>" class="btn btn-info float-right btn-sm"><i class="fas fa-reply"></i> Back</a>
                </div>
            </div>

            <div class="card-body">
                <?= form_open_multipart('walikelas/siswa/updatesiswa/' . $siswa['id_siswa']); ?>
                <?= csrf_field(); ?>
