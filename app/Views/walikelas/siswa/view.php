        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?= base_url('walikelas/siswa/anggota_rombel/' . session()->get('rombel')) ?>" class="btn btn-info float-right btn-sm"><i class="fas fa-reply"></i> Back</a>
                </div>
            </div>
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <a href="<?= base_url('walikelas/siswa/editwali/' . $siswa['id_siswa']); ?>" class="btn btn-primary btn-sm"><i class="far fa-edit"> Edit</i> </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                        ...
                        <div class="text-center mt-5 mb-3">
                            <a href="<?= base_url('walikelas/siswa/editsiswa/' . $siswa['id_siswa']); ?>" class="btn btn-primary btn-sm"><i class="far fa-edit"> Edit</i></a>
                            <a href="<?= base_url('walikelas/siswa/delete/' . $siswa['id_siswa']); ?>" class="btn btn-danger btn-sm btn-hapus"><i class="fas fa-trash"> Delete</i></a>
                        </div>
                    </div>
                </div>
            </div><!-- /.card-body -->
