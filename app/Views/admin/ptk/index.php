                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="<?= base_url('./admin/ptk/add') ?>" class="btn btn-primary btn-sm">
                                    ...
                                    <?php foreach ($ptk as $key) : ?>
                                        <tr>
                                            ...
                                            <!-- <td class="text-center">
                                                <a href="ptk/edit/<?= $key['id_ptk']; ?>" class="btn btn-sm btn-primary"> Edit</a>
                                                <a href="ptk/delete/<?= $key['id_ptk']; ?>" class="btn btn-danger btn-sm btn-hapus"><i class="fas fa-trash"></i></a>
                                            </td> -->
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
