                                    ...
                                    <?php foreach ($rombelKelas as $key) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('admin/kelas/delete_anggota_rombel/' . $key['id_siswa'] . '/' . $key['id_siswa']); ?>" class="btn btn-danger btn-sm btn-remove">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($siswa_tpk as $key) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $key['nama_siswa']; ?></td>
                                    <td class="text-center">
                                        <a href="<?= base_url('admin/rombel/add_anggota_rombel/' . $key['id_siswa'] . '/' . $key['id_siswa']); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
