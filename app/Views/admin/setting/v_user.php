                            ...
                            <table class="table table-bordered table-hover table-sm">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($user as $key) : ?>
                                        <tr>
                                            <td class="text-center"><img src="<?= base_url('public/assets/foto/user/' . $key['foto_user']) ?>" class="img-circle elevation-2 foto" alt="User Image"></td>
                                            <td><?= $key['namauser']; ?></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input name="namauser" id="namauser" class="form-control" placeholder="Name User" required>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="namauser" class="col-sm-4 col-form-label">Nama User</label>
                            <div class="col-sm-8">
                                <input name="namauser" class="form-control" value="<?= $value['namauser']; ?>">
                            </div>
                        </div>
