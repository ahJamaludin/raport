    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0"><?= $title1 ?> : <?= $detailkelas['kode_kelas']; ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            <table class="table table-borderless">
                                <tr>
                                    <th withd="10px">Tahun Pelajaran</th>
                                    <th withd="30px">:</th>
                                    <td><?= $ta_aktif['tahun'] ?></td>
                                        ...
                                        <?php if ($detailkelas['id_kelas'] == $key['id_kelas']) { ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="<?= base_url('admin/mapelkelas/delete/' . $key['id_mapelkelas']); ?>" class="btn btn-danger btn-sm btn-hapus"><i class="fas fa-trash"></i></a>
