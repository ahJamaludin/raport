...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/frontend/plugins/bootstrap/bootstrap.min.css">
    <!-- slick slider -->
    <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/frontend/plugins/slick/slick.css">
    <!-- themefy-icon -->
    <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/frontend/plugins/themify-icons/themify-icons.css">
    <!-- animation css -->
    <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/frontend/plugins/animate/animate.css">
    <!-- aos -->
    <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/frontend/plugins/aos/aos.css">
    <!-- venobox popup -->
    <link rel="stylesheet" href="<?= base_url(); ?>/public/assets/frontend/plugins/venobox/venobox.css">

    <!-- Main Stylesheet -->
    <link href="<?= base_url(); ?>/public/assets/frontend/css/style.css" rel="stylesheet">

    <!--Favicon-->
    <link rel="shortcut icon" href="<?= base_url(); ?>/public/assets/frontend/images/favicon.png" type="image/x-icon">
    <link rel="icon" href="<?= base_url(); ?>/public/assets/frontend/images/favicon.png" type="image/x-icon">
...
<body>
    <!-- preloader start -->
    <div class="preloader">
        <img src="<?= base_url(); ?>/public/assets/frontend/images/preloader.gif" alt="preloader">
    </div>
    <!-- preloader end -->
        ...
        <div class="navigation w-100">
            <div class="container">
                <nav class="navbar navbar-expand-lg ">
                    <a class="navbar-brand" href="index.html"><img src="<?= base_url(); ?>/public/assets/frontend/images/logo.png" alt="logo" width="60px"></a>
    ...
    <!-- hero slider -->
    <section class="hero-section overlay bg-cover" data-background="<?= base_url(); ?>/public/assets/frontend/images/banner/biground.jpg">
        <div class="container">
    ...
    <!-- jQuery -->
    <script src="<?= base_url(); ?>/public/assets/frontend/plugins/jQuery/jquery.min.js"></script>
    <!-- Bootstrap JS -->
    <script src="<?= base_url(); ?>/public/assets/frontend/plugins/bootstrap/bootstrap.min.js"></script>
    <!-- slick slider -->
    <script src="<?= base_url(); ?>/public/assets/frontend/plugins/slick/slick.min.js"></script>
    <!-- aos -->
    <script src="<?= base_url(); ?>/public/assets/frontend/plugins/aos/aos.js"></script>
    <!-- venobox popup -->
    <script src="<?= base_url(); ?>/public/assets/frontend/plugins/venobox/venobox.min.js"></script>
    <!-- filter -->
    <script src="<?= base_url(); ?>/public/assets/frontend/plugins/filterizr/jquery.filterizr.min.js"></script>
    <!-- google map -->
    <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu5nZKbeK-WHQ70oqOWo-_4VmwOwKP9YQ"></script> -->
    <script src="<?= base_url(); ?>/public/assets/frontend/plugins/google-map/gmap.js"></script>

    <!-- Main Script -->
    <script src="<?= base_url(); ?>/public/assets/frontend/js/script.js"></script>
